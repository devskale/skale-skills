# surf/lib/help-command.sh — per-command help DETAIL (48 blocks) + the cmd_help
# dispatcher. Sourced by surf.sh. Split from help.sh (Q2-B): the detail data and
# its dispatcher live here, separate from the overview index in help-overview.sh.
