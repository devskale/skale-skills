...
- **Ryanair example**: Instead of `rodney click` on the booking form, call the fare API directly. See [references/api/ryanair.md](references/api/ryanair.md) for documented endpoints.
