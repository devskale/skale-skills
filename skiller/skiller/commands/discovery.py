...
from skiller.core import discover_skills_in_tree, list_skills_simple
...
def _run_interactive(config: dict) -> None:
    base_dir = os.getcwd()
    discovery_choices = ["custom_dirs", "./"]
    discovery_scope = select_option(
        "Discover skills in:", discovery_choices, default="custom_dirs"
    )
